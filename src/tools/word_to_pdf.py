...
class WordToPDFScreen(BaseToolScreen):
    def __init__(self, parent, app):
        super().__init__(parent, app, "Word → PDF")

        self.files: Sequence[str] = ()
        self.output_dir: str = ""

        self.add_button("Select Word Files", self.select_files)
    ...
    def select_files(self):
        self.files = filedialog.askopenfilenames(
            ...
            filetypes=[("Word Documents", "*.docx"), ("All Word Files", "*.doc *.docx"), ("All Files", "*.*")]
        )
        if self.files:
            self.mark_done(0)
    ...
    def process(self):
        ...
        try:
            ...
            self.mark_done(2)
            self.set_instruction("Word to PDF conversion completed successfully")
